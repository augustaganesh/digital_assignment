...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-8 columnhead pt-3">
            <h5 class="font-weight-bold pb-3 text-left" style="margin-left: 14px;">Filter Subject (Semester-wise)</h3>
                ...
                <span class="float-right text-light pb-4 position-absolute" style="top:10px;right:18px"> <input type="text" class="form-control" name="search" id="mysearch" placeholder="&#128270; search teachers..">
                </span>
                <br>
