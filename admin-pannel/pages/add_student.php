...
if (isset($_POST['submit'])) {
    ...
    $checkRoll = $obj->Query("SELECT * from tbl_student where sname='$s' and roll_no = '$roll'");
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8 shadow pt-3 columnhead ml-3" style="min-height:85vh;">
            ...
            <h5 class="font-weight-bold pb-3 text-left" style="margin-left: 14px;">Filter Student (Semester-wise)</h3>
                            ...
                            <tbody>
                                <?php foreach ($students as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url('add_student.php?action=d&id=' . $value['sid']) ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure you want to delete?')"><i class="far fa-trash-alt"></i></a></td>
